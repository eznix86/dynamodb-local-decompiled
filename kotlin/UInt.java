...
implements Comparable<UInt> {
    ...
    private static final int compareTo-7apg3OU(int arg0, byte other) {
        return UnsignedKt.uintCompare(arg0, UInt.constructor-impl(other & 0xFF));
    }

    @InlineOnly
    private static final int compareTo-xj2QHRw(int arg0, short other) {
        return UnsignedKt.uintCompare(arg0, UInt.constructor-impl(other & 0xFFFF));
    }
    ...
    private static final int compareTo-VKZWuLQ(int arg0, long other) {
        return UnsignedKt.ulongCompare(ULong.constructor-impl((long)arg0 & 0xFFFFFFFFL), other);
    }
    ...
    private static final int div-7apg3OU(int arg0, byte other) {
        return UnsignedKt.uintDivide-J1ME1BU(arg0, UInt.constructor-impl(other & 0xFF));
    }

    @InlineOnly
    private static final int div-xj2QHRw(int arg0, short other) {
        return UnsignedKt.uintDivide-J1ME1BU(arg0, UInt.constructor-impl(other & 0xFFFF));
    }
    ...
    private static final long div-VKZWuLQ(int arg0, long other) {
        return UnsignedKt.ulongDivide-eb3DHEI(ULong.constructor-impl((long)arg0 & 0xFFFFFFFFL), other);
    }

    @InlineOnly
    private static final int rem-7apg3OU(int arg0, byte other) {
        return UnsignedKt.uintRemainder-J1ME1BU(arg0, UInt.constructor-impl(other & 0xFF));
    }

    @InlineOnly
    private static final int rem-xj2QHRw(int arg0, short other) {
        return UnsignedKt.uintRemainder-J1ME1BU(arg0, UInt.constructor-impl(other & 0xFFFF));
    }
    ...
    private static final long rem-VKZWuLQ(int arg0, long other) {
        return UnsignedKt.ulongRemainder-eb3DHEI(ULong.constructor-impl((long)arg0 & 0xFFFFFFFFL), other);
    }
    ...
    private static final byte mod-7apg3OU(int arg0, byte other) {
        int n = UInt.constructor-impl(other & 0xFF);
        return UByte.constructor-impl((byte)UnsignedKt.uintRemainder-J1ME1BU(arg0, n));
    }

    @InlineOnly
    private static final short mod-xj2QHRw(int arg0, short other) {
        int n = UInt.constructor-impl(other & 0xFFFF);
        return UShort.constructor-impl((short)UnsignedKt.uintRemainder-J1ME1BU(arg0, n));
    }
