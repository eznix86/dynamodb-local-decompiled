...
extends MapsKt__MapsJVMKt {
    ...
    private static final <K, V> Map<K, V> buildMap(int capacity, @BuilderInference Function1<? super Map<K, V>, Unit> builderAction) {
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        Map map2 = MapsKt.createMapBuilder(capacity);
        builderAction.invoke(map2);
        return MapsKt.build(map2);
    }
    ...
    private static final <K, V> Map<K, V> orEmpty(Map<K, ? extends V> $this$orEmpty) {
        Map<K, Object> map2 = $this$orEmpty;
        if (map2 == null) {
    ...
    public static final <K, V, R> Map<K, R> mapValues(@NotNull Map<? extends K, ? extends V> $this$mapValues, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        ...
        for (Object element$iv$iv : $this$associateByTo$iv$iv) {
            ...
            boolean bl = false;
            map3.put(it$iv.getKey(), transform.invoke((Map.Entry<K, V>)element$iv$iv));
        }
    ...
    public static final <K, V> Map<K, V> filter(@NotNull Map<? extends K, ? extends V> $this$filter, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
        ...
        Map<? extends K, ? extends V> map2 = $this$filter;
    ...
    public static final <K, V> Map<K, V> filterNot(@NotNull Map<? extends K, ? extends V> $this$filterNot, @NotNull Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
        ...
        Map<? extends K, ? extends V> map2 = $this$filterNot;
        Map destination$iv = new LinkedHashMap();
        boolean $i$f$filterNotTo = false;
    ...
    public static final <K, V> Map<K, V> toMap(@NotNull Pair<? extends K, ? extends V>[] $this$toMap) {
        ...
        switch ($this$toMap.length) {
            ...
            case 1: {
                map2 = MapsKt.mapOf($this$toMap[0]);
                break;
            }
            default: {
                map2 = MapsKt.toMap($this$toMap, (Map)new LinkedHashMap(MapsKt.mapCapacity($this$toMap.length)));
            }
        }
        return map2;
    }
    ...
    @NotNull
    public static final <K, V> Map<K, V> plus(@NotNull Map<? extends K, ? extends V> $this$plus, @NotNull Map<? extends K, ? extends V> map2) {
        LinkedHashMap<? extends K, ? extends V> linkedHashMap;
        Intrinsics.checkNotNullParameter($this$plus, "<this>");
    ...
    @InlineOnly
    private static final <K, V> void plusAssign(Map<? super K, ? super V> $this$plusAssign, Map<K, ? extends V> map2) {
        Intrinsics.checkNotNullParameter($this$plusAssign, "<this>");
        Intrinsics.checkNotNullParameter(map2, "map");
        $this$plusAssign.putAll(map2);
    }
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> $this$minus, K key) {
        ...
        Map<K, V> $this$minus_u24lambda_u2d16 = map2 = MapsKt.toMutableMap($this$minus);
        boolean bl = false;
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> $this$minus, @NotNull Iterable<? extends K> keys2) {
        ...
        Map<K, V> $this$minus_u24lambda_u2d17 = map2 = MapsKt.toMutableMap($this$minus);
        boolean bl = false;
        CollectionsKt.removeAll((Collection)$this$minus_u24lambda_u2d17.keySet(), keys2);
        return MapsKt.optimizeReadOnlyMap(map2);
    }
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> $this$minus, @NotNull K[] keys2) {
        ...
        Intrinsics.checkNotNullParameter($this$minus, "<this>");
        Intrinsics.checkNotNullParameter(keys2, "keys");
        Map<K, V> $this$minus_u24lambda_u2d18 = map2 = MapsKt.toMutableMap($this$minus);
        boolean bl = false;
        CollectionsKt.removeAll((Collection)$this$minus_u24lambda_u2d18.keySet(), keys2);
        return MapsKt.optimizeReadOnlyMap(map2);
    }
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> $this$minus, @NotNull Sequence<? extends K> keys2) {
        ...
        Intrinsics.checkNotNullParameter($this$minus, "<this>");
        Intrinsics.checkNotNullParameter(keys2, "keys");
        Map<K, V> $this$minus_u24lambda_u2d19 = map2 = MapsKt.toMutableMap($this$minus);
        boolean bl = false;
        CollectionsKt.removeAll((Collection)$this$minus_u24lambda_u2d19.keySet(), keys2);
        return MapsKt.optimizeReadOnlyMap(map2);
    }
