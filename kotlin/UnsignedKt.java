...
public final class UnsignedKt {
    ...
    public static final long ulongDivide-eb3DHEI(long v1, long v2) {
        ...
        return ULong.constructor-impl(quotient + (long)(UnsignedKt.ulongCompare(ULong.constructor-impl(rem), ULong.constructor-impl(divisor)) >= 0 ? 1 : 0));
    }
    ...
    public static final long ulongRemainder-eb3DHEI(long v1, long v2) {
        ...
        return ULong.constructor-impl(rem - (UnsignedKt.ulongCompare(ULong.constructor-impl(rem = dividend - quotient * divisor), ULong.constructor-impl(divisor)) >= 0 ? divisor : 0L));
    }
