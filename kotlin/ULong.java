...
implements Comparable<ULong> {
    ...
    private static final int compareTo-7apg3OU(long arg0, byte other) {
        return UnsignedKt.ulongCompare(arg0, ULong.constructor-impl((long)other & 0xFFL));
    }

    @InlineOnly
    private static final int compareTo-xj2QHRw(long arg0, short other) {
        return UnsignedKt.ulongCompare(arg0, ULong.constructor-impl((long)other & 0xFFFFL));
    }

    @InlineOnly
    private static final int compareTo-WZ4Q5Ns(long arg0, int other) {
        return UnsignedKt.ulongCompare(arg0, ULong.constructor-impl((long)other & 0xFFFFFFFFL));
    }
    ...
    private static final long div-7apg3OU(long arg0, byte other) {
        return UnsignedKt.ulongDivide-eb3DHEI(arg0, ULong.constructor-impl((long)other & 0xFFL));
    }

    @InlineOnly
    private static final long div-xj2QHRw(long arg0, short other) {
        return UnsignedKt.ulongDivide-eb3DHEI(arg0, ULong.constructor-impl((long)other & 0xFFFFL));
    }

    @InlineOnly
    private static final long div-WZ4Q5Ns(long arg0, int other) {
        return UnsignedKt.ulongDivide-eb3DHEI(arg0, ULong.constructor-impl((long)other & 0xFFFFFFFFL));
    }
    ...
    private static final long rem-7apg3OU(long arg0, byte other) {
        return UnsignedKt.ulongRemainder-eb3DHEI(arg0, ULong.constructor-impl((long)other & 0xFFL));
    }

    @InlineOnly
    private static final long rem-xj2QHRw(long arg0, short other) {
        return UnsignedKt.ulongRemainder-eb3DHEI(arg0, ULong.constructor-impl((long)other & 0xFFFFL));
    }

    @InlineOnly
    private static final long rem-WZ4Q5Ns(long arg0, int other) {
        return UnsignedKt.ulongRemainder-eb3DHEI(arg0, ULong.constructor-impl((long)other & 0xFFFFFFFFL));
    }
    ...
    private static final byte mod-7apg3OU(long arg0, byte other) {
        long l = ULong.constructor-impl((long)other & 0xFFL);
        return UByte.constructor-impl((byte)UnsignedKt.ulongRemainder-eb3DHEI(arg0, l));
    }

    @InlineOnly
    private static final short mod-xj2QHRw(long arg0, short other) {
        long l = ULong.constructor-impl((long)other & 0xFFFFL);
        return UShort.constructor-impl((short)UnsignedKt.ulongRemainder-eb3DHEI(arg0, l));
    }

    @InlineOnly
    private static final int mod-WZ4Q5Ns(long arg0, int other) {
        long l = ULong.constructor-impl((long)other & 0xFFFFFFFFL);
        return UInt.constructor-impl((int)UnsignedKt.ulongRemainder-eb3DHEI(arg0, l));
    }
