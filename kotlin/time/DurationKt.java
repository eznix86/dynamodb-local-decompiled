    ...
    private static final long parseDuration(String value, boolean strictIso) {
        ...
        if (value.charAt(index) == 'P') {
            ...
            while (index < length) {
                ...
                Intrinsics.checkNotNullExpressionValue(string.substring(index, $this$skipWhile$iv$iv22), "this as java.lang.String\u2026ing(startIndex, endIndex)");
                if (((CharSequence)component).length() == 0) {
                    throw new IllegalArgumentException();
                }
                CharSequence $i$f$substringWhile22 = value;
                if ((index += component.length()) < 0 || index > StringsKt.getLastIndex($i$f$substringWhile22)) {
                    int it = index;
                    boolean bl = false;
                ...
                if (unit == DurationUnit.SECONDS && dotIndex > 0) {
                    ...
                    i$iv$iv = 0;
                    Intrinsics.checkNotNullExpressionValue($i$f$skipWhile2.substring(i$iv$iv, dotIndex), "this as java.lang.String\u2026ing(startIndex, endIndex)");
                    result = Duration.plus-LRDsOJo(result, DurationKt.toDuration(DurationKt.parseOverLongIsoComponent(whole), unit));
                    String string2 = component.substring(dotIndex);
                    Intrinsics.checkNotNullExpressionValue(string2, "this as java.lang.String).substring(startIndex)");
                    result = Duration.plus-LRDsOJo(result, DurationKt.toDuration(Double.parseDouble(string2), unit));
                    continue;
                }
            ...
            if (StringsKt.regionMatches(value, index, infinityString, 0, Math.max(length - index, infinityString.length()), true)) {
                ...
                while (index < length) {
                    ...
                    Intrinsics.checkNotNullExpressionValue(it.substring(index, $this$skipWhile$iv$iv422), "this as java.lang.String\u2026ing(startIndex, endIndex)");
                    if (((CharSequence)component).length() == 0) {
                        throw new IllegalArgumentException();
                    }
                    ...
                    int n = i$iv$iv;
                    Intrinsics.checkNotNullExpressionValue($this$skipWhile$iv$iv422.substring(index, n), "this as java.lang.String\u2026ing(startIndex, endIndex)");
                    ...
                    if (dotIndex > 0) {
                        ...
                        int n2 = 0;
                        Intrinsics.checkNotNullExpressionValue(string.substring(n2, dotIndex), "this as java.lang.String\u2026ing(startIndex, endIndex)");
                        result = Duration.plus-LRDsOJo(result, DurationKt.toDuration(Long.parseLong(whole), unit));
                        String string3 = component.substring(dotIndex);
