...
extends StringsKt__StringsJVMKt {
    ...
    public static final CharSequence padEnd(@NotNull CharSequence $this$padEnd, int length, char padChar) {
        ...
        int i = 1;
        int n = length - $this$padEnd.length();
        if (i <= n) {
            while (true) {
                sb.append(padChar);
                if (i == n) break;
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence $this$rangesDelimitedBy, char[] delimiters, int startIndex, boolean ignoreCase, int limit2) {
        StringsKt.requireNonNegativeLimit(limit2);
        return new DelimitedRangesSequence($this$rangesDelimitedBy, startIndex, limit2, (Function2<? super CharSequence, ? super Integer, Pair<Integer, Integer>>)new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>(delimiters, ignoreCase){
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence $this$rangesDelimitedBy, String[] delimiters, int startIndex, boolean ignoreCase, int limit2) {
        StringsKt.requireNonNegativeLimit(limit2);
        List<String> delimitersList = ArraysKt.asList(delimiters);
        return new DelimitedRangesSequence($this$rangesDelimitedBy, startIndex, limit2, (Function2<? super CharSequence, ? super Integer, Pair<Integer, Integer>>)new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>(delimitersList, ignoreCase){
    ...
    public static final void requireNonNegativeLimit(int limit2) {
        boolean bl;
        boolean bl2 = bl = limit2 >= 0;
        if (!bl) {
            boolean bl3 = false;
            String string = "Limit must be non-negative, but was " + limit2;
            throw new IllegalArgumentException(string.toString());
        }
    }

    @NotNull
    public static final Sequence<String> splitToSequence(@NotNull CharSequence $this$splitToSequence, @NotNull String[] delimiters, boolean ignoreCase, int limit2) {
        Intrinsics.checkNotNullParameter($this$splitToSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt.map(StringsKt__StringsKt.rangesDelimitedBy$StringsKt__StringsKt$default($this$splitToSequence, delimiters, 0, ignoreCase, limit2, 2, null), (Function1)new Function1<IntRange, String>($this$splitToSequence){
     ...
     */
    @NotNull
    public static final List<String> split(@NotNull CharSequence $this$split, @NotNull String[] delimiters, boolean ignoreCase, int limit2) {
        void $this$mapTo$iv$iv;
        String delimiter;
        Intrinsics.checkNotNullParameter($this$split, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        if (delimiters.length == 1 && !(((CharSequence)(delimiter = delimiters[0])).length() == 0)) {
            return StringsKt__StringsKt.split$StringsKt__StringsKt($this$split, delimiter, ignoreCase, limit2);
        }
        Iterable $this$map$iv = SequencesKt.asIterable(StringsKt__StringsKt.rangesDelimitedBy$StringsKt__StringsKt$default($this$split, delimiters, 0, ignoreCase, limit2, 2, null));
    ...
    @NotNull
    public static final Sequence<String> splitToSequence(@NotNull CharSequence $this$splitToSequence, @NotNull char[] delimiters, boolean ignoreCase, int limit2) {
        Intrinsics.checkNotNullParameter($this$splitToSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt.map(StringsKt__StringsKt.rangesDelimitedBy$StringsKt__StringsKt$default($this$splitToSequence, delimiters, 0, ignoreCase, limit2, 2, null), (Function1)new Function1<IntRange, String>($this$splitToSequence){
            final /* synthetic */ CharSequence $this_splitToSequence;
     ...
     */
    @NotNull
    public static final List<String> split(@NotNull CharSequence $this$split, @NotNull char[] delimiters, boolean ignoreCase, int limit2) {
        void $this$mapTo$iv$iv;
        Intrinsics.checkNotNullParameter($this$split, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        if (delimiters.length == 1) {
            return StringsKt__StringsKt.split$StringsKt__StringsKt($this$split, String.valueOf(delimiters[0]), ignoreCase, limit2);
        }
        Iterable $this$map$iv = SequencesKt.asIterable(StringsKt__StringsKt.rangesDelimitedBy$StringsKt__StringsKt$default($this$split, delimiters, 0, ignoreCase, limit2, 2, null));
        boolean $i$f$map = false;
        Iterable iterable = $this$map$iv;
    ...
    private static final List<String> split$StringsKt__StringsKt(CharSequence $this$split, String delimiter, boolean ignoreCase, int limit2) {
        StringsKt.requireNonNegativeLimit(limit2);
        int currentOffset = 0;
        int nextIndex = StringsKt.indexOf($this$split, delimiter, currentOffset, ignoreCase);
        if (nextIndex == -1 || limit2 == 1) {
            return CollectionsKt.listOf(((Object)$this$split).toString());
        }
        boolean isLimited = limit2 > 0;
        ArrayList<String> result = new ArrayList<String>(isLimited ? RangesKt.coerceAtMost(limit2, 10) : 10);
        do {
            result.add(((Object)$this$split.subSequence(currentOffset, nextIndex)).toString());
            currentOffset = nextIndex + delimiter.length();
        } while ((!isLimited || result.size() != limit2 - 1) && (nextIndex = StringsKt.indexOf($this$split, delimiter, currentOffset, ignoreCase)) != -1);
        result.add(((Object)$this$split.subSequence(currentOffset, $this$split.length())).toString());
        return result;
    }

    @InlineOnly
    private static final List<String> split(CharSequence $this$split, Regex regex, int limit2) {
        Intrinsics.checkNotNullParameter($this$split, "<this>");
        Intrinsics.checkNotNullParameter(regex, "regex");
        return regex.split($this$split, limit2);
    }

    static /* synthetic */ List split$default(CharSequence $this$split_u24default, Regex regex, int limit2, int n, Object object) {
        if ((n & 2) != 0) {
            limit2 = 0;
        }
        Intrinsics.checkNotNullParameter($this$split_u24default, "<this>");
        Intrinsics.checkNotNullParameter(regex, "regex");
        return regex.split($this$split_u24default, limit2);
    }

    @SinceKotlin(version="1.6")
    @WasExperimental(markerClass={ExperimentalStdlibApi.class})
    @InlineOnly
    private static final Sequence<String> splitToSequence(CharSequence $this$splitToSequence, Regex regex, int limit2) {
        Intrinsics.checkNotNullParameter($this$splitToSequence, "<this>");
        Intrinsics.checkNotNullParameter(regex, "regex");
        return regex.splitToSequence($this$splitToSequence, limit2);
    }

    static /* synthetic */ Sequence splitToSequence$default(CharSequence $this$splitToSequence_u24default, Regex regex, int limit2, int n, Object object) {
        if ((n & 2) != 0) {
            limit2 = 0;
        }
        Intrinsics.checkNotNullParameter($this$splitToSequence_u24default, "<this>");
        Intrinsics.checkNotNullParameter(regex, "regex");
        return regex.splitToSequence($this$splitToSequence_u24default, limit2);
    }
