...
implements Sequence<IntRange> {
    ...
    public DelimitedRangesSequence(@NotNull CharSequence input, int startIndex, int limit2, @NotNull Function2<? super CharSequence, ? super Integer, Pair<Integer, Integer>> getNextMatch) {
