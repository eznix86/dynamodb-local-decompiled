...
public final class RegexKt {
    ...
    private static final /* synthetic */ <T extends Enum<T>> Set<T> fromInt(int value) {
        ...
        Intrinsics.checkNotNullExpressionValue(set2, "unmodifiableSet(EnumSet.\u2026mask == it.value }\n    })");
        return set2;
    }

    private static final MatchResult findNext(Matcher $this$findNext, int from2, CharSequence input) {
        return !$this$findNext.find(from2) ? null : (MatchResult)new MatcherMatchResult($this$findNext, input);
    }
    ...
    public static final /* synthetic */ MatchResult access$findNext(Matcher $receiver, int from2, CharSequence input) {
        return RegexKt.findNext($receiver, from2, input);
    }
