...
implements Serializable {
    ...
    @NotNull
    public final List<String> split(@NotNull CharSequence input, int limit2) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit2);
        Matcher matcher = this.nativePattern.matcher(input);
        if (limit2 == 1 || !matcher.find()) {
            return CollectionsKt.listOf(((Object)input).toString());
        }
        ArrayList<String> result = new ArrayList<String>(limit2 > 0 ? RangesKt.coerceAtMost(limit2, 10) : 10);
        int lastStart = 0;
        int lastSplit = limit2 - 1;
        do {
    ...
    @NotNull
    public final Sequence<String> splitToSequence(@NotNull CharSequence input, int limit2) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit2);
        return SequencesKt.sequence((Function2)new Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object>(this, input, limit2, null){
            Object L$1;
            int I$0;
            int label;
