...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(@NotNull String $this$toUByteOrNull, int radix) {
        ...
        int n2 = -1;
        if (UnsignedKt.uintCompare(n, UInt.constructor-impl(n2 & 0xFF)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(@NotNull String $this$toUShortOrNull, int radix) {
        ...
        int n = uInt.unbox-impl();
        int n2 = -1;
        if (UnsignedKt.uintCompare(n, UInt.constructor-impl(n2 & 0xFFFF)) > 0) {
            return null;
        }
        ...
        for (int i = start; i < length; ++i) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == limitForMaxRadix) {
                    limitBeforeMul = UnsignedKt.uintDivide-J1ME1BU(limit2, uradix);
                    if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            if (UnsignedKt.uintCompare(result = UInt.constructor-impl(result + UInt.constructor-impl(digit)), beforeAdding) >= 0) continue;
            return null;
        }
    ...
    public static final ULong toULongOrNull(@NotNull String $this$toULongOrNull, int radix) {
        ...
        for (int i = start; i < length; ++i) {
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == limitForMaxRadix) {
                    limitBeforeMul = UnsignedKt.ulongDivide-eb3DHEI(limit2, uradix);
                    if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            if (UnsignedKt.ulongCompare(result = ULong.constructor-impl(result + ULong.constructor-impl((long)n & 0xFFFFFFFFL)), beforeAdding) >= 0) continue;
            return null;
        }
