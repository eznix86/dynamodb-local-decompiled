...
extends StringsKt__StringNumberConversionsKt {
    ...
    @NotNull
    public static final List<String> split(@NotNull CharSequence $this$split, @NotNull Pattern regex, int limit2) {
        Intrinsics.checkNotNullParameter($this$split, "<this>");
        Intrinsics.checkNotNullParameter(regex, "regex");
        StringsKt.requireNonNegativeLimit(limit2);
        String[] stringArray = regex.split($this$split, limit2 == 0 ? -1 : limit2);
